...
class VolumesControllerTest < ActionController::TestCase
  ...
  test "should create volume" do
    assert_difference('Volume.count') do
      post :create, volume: { own: @volume.own, series_id: @volume.series_id, volume_number: @volume.volume_number }
    end
  ...
  test "should update volume" do
    put :update, id: @volume, volume: { own: @volume.own, series_id: @volume.series_id, volume_number: @volume.volume_number }
    assert_redirected_to volume_path(assigns(:volume))
  end
